...
$('hospital').addEvent('change', function(ev) {
    console.log('change');
    var hospitalID = this.get('value');
    $('hospital-department-blank').set('selected', 'selected');
    $$('.hospital-department').addClass('hide');
    $$('.hospital-' + hospitalID).removeClass('hide');
});